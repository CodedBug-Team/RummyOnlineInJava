...
<!--<link href="../../css/main.css" rel="stylesheet" type="text/css" />-->
  	...
  	<link rel="stylesheet" href="user-details/game/play-cash/css/slide.css" type="text/css" media="screen" />
        ...
        <link rel="stylesheet" href="user-details/game/play-cash/css/chat.css" type="text/css" media="screen" />
  	<!-- PNG FIX for IE6 -->
	...
	<script src="user-details/game/play-cash/js/jquery-1.3.2.min.js" type="text/javascript"></script>
        <script src="user-details/game/play-cash/js/jquery-1.4.2.js" type="text/javascript"></script>
        <script src="user-details/game/play-cash/js/jquery.ui.core.js" type="text/javascript"></script>
        <script src="user-details/game/play-cash/js/jquery.ui.widget.js" type="text/javascript"></script>
        <script src="user-details/game/play-cash/js/jquery.ui.mouse.js" type="text/javascript"></script>
        <script src="user-details/game/play-cash/js/jquery.ui.draggable.js" type="text/javascript"></script>
        <script src="user-details/game/play-cash/js/jquery.ui.sortable.js" type="text/javascript"></script>
