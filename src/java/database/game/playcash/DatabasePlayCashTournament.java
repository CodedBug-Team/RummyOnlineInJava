...
import actions.generategame.GenerateGame;
 ...
 * @author Abhishek
 */
public class DatabasePlayCashTournament implements ServletRequestAware{
    
        private String username;
        private  ArrayList cash_tournament_num;
        int cash_tournament_num1;   //this is the game id
    ...
    public int getIdcash_tournament1() {
        return idcash_tournament1;
    }

    public void setIdcash_tournament1(int idcash_tournament1) {
        this.idcash_tournament1 = idcash_tournament1;
    }
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    session = ActionContext.getContext().getSession();
        ...
        System.out.println("maxjoined"+maxjoined);
//        String s=getServletRequest().getParameter("cash_tournament_num1");
//        
//        System.out.println("s"+s);
        //System.out.println("got this value\t"+cash_tournament_num1);
         if(cash_tournament_num1==0)
        {
...
stmt1.setInt(1,cash_tournament_num1);
...
stmt8.setInt(1,cash_tournament_num1);
stmt8.setString(2,time);
stmt8.setInt(3,entryfee);
stmt8.setString(4,prize);
stmt8.setInt(5,maxjoined);
//stmt1.setInt(5,joined);
stmt8.setInt(6,1);
stmt8.executeUpdate();

stmt8=connection.prepareStatement("insert into user_cash_tournament (cash_tournament_num1, cash_tournament_username) values (?,?)");
stmt8.setInt(1,cash_tournament_num1);
stmt8.setString(2,username);
stmt8.execute();
stmt8.close();
        }
...
stmt9.execute();
stmt9=connection.prepareStatement("insert into user_cash_tournament (cash_tournament_num1, cash_tournament_username) values (?,?)");
stmt9.setInt(1,cash_tournament_num1);
stmt9.setString(2,username);
stmt9.execute();
generateRandom();
        }
            catch(SQLException e)
...
gg.showRandomInteger(START, END, random);
